...
wb=openpyxl.load_workbook('E:\Customers\Customers\SecureEye IOC\IOC_2018_05_18.xlsx', 'r')  ## Specify the IOC workbook with Full Path
...
def ioc_update(value,ref_set_name):
    ...
    headers={'Accept': 'application/json','SEC':'XXXXXXXXXXXXXXX','Version': '7.0', } ### Enter the api key generated from QRadar Console.
